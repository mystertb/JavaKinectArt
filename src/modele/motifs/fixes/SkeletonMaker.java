    ...
    public void skeletonUpdate(Skeleton skel) {
        ...
        switch (skel) {
            ...
            case epaule_gauche:
            	//epaule gauche
            	/*
            	this.formePartieSkeleton.add(FormeGeo.cercle);
                this.listePoints.add(new SkeletonPoint(Skeleton.epaule_gauche));
                this.partiesSkeleton.add(listePoints);
                listePoints = new ArrayList<SkeletonPoint>();
                */
            ...
            case epaule_droite:
            	...
            	/*
            	this.formePartieSkeleton.add(FormeGeo.cercle);
                this.listePoints.add(new SkeletonPoint(Skeleton.epaule_droite));
                this.partiesSkeleton.add(listePoints);
                listePoints = new ArrayList<SkeletonPoint>();
                */
            ...
            case coude_gauche:
            	//coude gauche
            	/*this.formePartieSkeleton.add(FormeGeo.cercle);
                this.listePoints.add(new SkeletonPoint(Skeleton.coude_gauche));
                this.partiesSkeleton.add(listePoints);
                listePoints = new ArrayList<SkeletonPoint>();*/
            ...
            case coude_droit:
            	//coude droit
            	/*this.formePartieSkeleton.add(FormeGeo.cercle);
                this.listePoints.add(new SkeletonPoint(Skeleton.collier_droit));
                this.partiesSkeleton.add(listePoints);
                listePoints = new ArrayList<SkeletonPoint>();*/
